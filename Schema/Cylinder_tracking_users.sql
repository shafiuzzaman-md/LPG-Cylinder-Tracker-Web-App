...
CREATE TABLE `users` (
  ...
  `Download Date` varchar(45) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  PRIMARY KEY (`Email`)
...
INSERT INTO `users` VALUES (1,'KAJOL','kajol@gmail.com','Dhaka','0198822322','123123','Dhaka','12-12-12');
